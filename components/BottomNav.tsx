...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-lucky-surface dark:bg-lucky-dark-surface border-t border-lucky-border dark:border-lucky-dark-border lg:hidden">
